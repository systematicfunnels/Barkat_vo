...
async function navigateTo(page: Page, section: string) {
  const link = SELECTORS[`${section}Link`];
...
async function fillForm(page: Page, data: Record<string, any>) {
  for (const [key, value] of Object.entries(data)) {
    const selector = SELECTORS[`${key}Input`] || SELECTORS[`${key}Select`] || `#${key}`;
...
async function createProject(page: Page, projectData: Partial<typeof testProject> = testProject) {
...
async function createUnit(page: Page, unitData: Partial<typeof testUnit> = testUnit, projectId?: number) {
...
async function createPayment(page: Page, paymentData: Partial<typeof testPayment> = testPayment, projectId?: number, unitId?: number) {
...
test.describe('Barkat Application - Full User Journey', () => {
  ...
  test.beforeAll(async () => {
    ...
    // Wait for app to load and get the main window
  ...
  test.describe('Authentication & Navigation', () => {
    test('should load dashboard and navigate to all sections', async () => {
    ...
    test('should handle navigation breadcrumbs correctly', async () => {
      await navigateTo(page, 'projects');
      await navigateTo(page, 'units');
  ...
  test.describe('Project Management', () => {
    test('should create, read, update, and delete projects', async () => {
      // Create project
    ...
    test('should validate project creation with invalid data', async () => {
      await navigateTo(page, 'projects');
      await page.click(SELECTORS.createProjectBtn);
      await page.waitForSelector(SELECTORS.modal);
    ...
    test('should handle project creation with boundary values', async () => {
  ...
  test.describe('Unit Management', () => {
    test('should create, read, update, and delete units', async () => {
    ...
    test('should validate unit creation with invalid data', async () => {
      await navigateTo(page, 'units');
      await page.click(SELECTORS.createUnitBtn);
      await page.waitForSelector(SELECTORS.modal);
    ...
    test('should handle unit creation with empty project selection', async () => {
      await navigateTo(page, 'units');
      await page.click(SELECTORS.createUnitBtn);
      await page.waitForSelector(SELECTORS.modal);
  ...
  test.describe('Payment Management', () => {
    ...
    test('should create, read, update, and delete payments', async () => {
      // Create payment
    ...
    test('should validate payment creation with invalid data', async () => {
      await navigateTo(page, 'payments');
      await page.click(SELECTORS.createPaymentBtn);
      await page.waitForSelector(SELECTORS.modal);
    ...
    test('should handle payment with boundary amount values', async () => {
  ...
  test.describe('Search and Filtering', () => {
    ...
    test('should filter units by project', async () => {
      await navigateTo(page, 'units');
    ...
    test('should search payments by amount', async () => {
      await navigateTo(page, 'payments');
